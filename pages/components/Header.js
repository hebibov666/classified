...
function Header({openLogin}){
    ...
    return(
    <div className='w-full fixed top-0 left-0 z-[100000000]  h-[70px] bg-red-600 flex justify-between pl-4 pr-2 items-center'>
...
<div onClick={()=>{dispatch(openCategory())}} className='w-[30px] h-[30px] rounded-[10px] bg-white lg:hidden flex items-center justify-center'>
