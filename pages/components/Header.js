...
<div className='flex items-center max-[490px]:w-full justify-center gap-[10px]'>
    <h1 className="text-2xl text-blue-700 max-[490px]:text-center  font-bold">Axtar.az</h1>
</div>
