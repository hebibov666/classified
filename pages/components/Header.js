...
const addPost=()=>{
    ...
    return(
    <div className='w-full top-0 left-0 z-[1]  h-[70px] bg-[#007FFF] max-[490px]:bg-white  max-[490px]:h-[50px]  flex justify-between pl-4 pr-2 items-center'>
<div className='flex items-center max-[490px]:w-full justify-start gap-[10px]'>
    <h1 className="text-2xl text-[#f00000] lg:text-white  font-bold">Axtar.az</h1>
</div>
