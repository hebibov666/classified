...
function AdvancedSearch(){
   ...
   const form=useSelector(state=>state.book.formId)
    ...
    return(
        <div className={`flex overflow-scroll noscroll flex-col justify-start z-[1]  fixed ${show ? 'left-0' : 'left-[-300%]'}  z-[999] anime top-0 left-0  bg-[#00000063] min-h-full h-[100vh]   w-[100%] max-[900px]:w-full  gap-[10px]`}>
