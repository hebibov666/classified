...
function SelectCategory({setCategory}) {
  ...
  return (
<div className='flex border-b-2 border-white p-2 max-[490px]:m-0 max-[490px]:rounded-[0px]  m-2 rounded-[10px]  overflow-scroll bg-white shadow-md shadow-[#EBEDF3] border-2 pb-[10px] mt-[10px] mb-[20px] border-[#EBEDF3]   gap-[20px] noscroll items-center'>
   {categories.map(item=>{
