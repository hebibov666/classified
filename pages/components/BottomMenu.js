...
<div class="fixed z-[10000] w-full h-16   bg-white border border-gray-200 min-[490px]:hidden bottom-0">
 ...
 <div onClick={()=>{newpost()}} class="flex items-center justify-center">
            <button data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-red-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
        ...
        <button  onClick={()=>{router.push("/AdvancedSearch")}}  data-tooltip-target="tooltip-settings" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
