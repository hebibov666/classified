                ...
                <div className="basis-[50%] rounded-[10px] max-[822px]:mt-[-30px] p-2 flex flex-col gap-[20px] justify-between  relative">
                    ...
                    <div className="flex justify-between">
                        <div className="flex w-full flex-col gap-[10px]">
                            ...
                            {product.camera && <div className="flex justify-between gap-[30px]"><p className="text-grey-500 font-bold">Kamera: </p> <p className="text-start">{product.camera}</p></div>}
                            {product.memory && <div className="flex justify-between gap-[30px]"><p className="text-grey-500 font-bold">Yaddaş: </p> <p className="text-start">{product.memory}</p></div>}
                            {product.engine && <div className="flex justify-between gap-[30px]"><p className="text-grey-500 font-bold">Mühərrik həcmi: </p> <p className="text-start">{product.engine}</p></div>}
                            ...
                            {product.walk && <div className="flex justify-between gap-[30px]"><p className="text-grey-500 font-bold">Yürüş: </p> <p className="text-start">{product.walk}</p></div>}
                    ...
                    <div>
                        <div className="flex flex-col">
                            <h1 className="text-xl font-bold">Mehsul haqqinda</h1>
