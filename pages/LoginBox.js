...
<div className="w-[35%] bg-white max-[490px]:h-[100%] max-[475px]:w-[100%] max-[475px]:rounded-[0px] max-[1019px]:w-[90%] lg-h-auto object-contain h-[70%] relative bg-[#F8F9FD] pt-[40px] flex flex-col items-center  max-[490px]:rounded-b-[0px] anime rounded-[10px] shadow-sm shadow-black">
<CancelIcon onClick={()=>{router.push("/")}} className='absolute right-2 top-2 ' fontSize='large'/>
